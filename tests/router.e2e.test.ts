...
test('routes to cheapest model by default', async () => {
    ...
    assert.ok(body.model, 'should return a model name')
    assert.ok(body.content, 'should return content')
    console.log('[price] model used:', body.model)
})
...
test('routes to highest throughput model by default', async () => {
    ...
    assert.ok(body.model, 'should return a model name')
    assert.ok(body.content, 'should return content')
    console.log('[throughput] model used:', body.model)
})
